...
app.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const base = (0, index_1.decodeUriParameter)(uriParameter);
 ...
 */
app.get('/zilla-segs/:hash/:segment', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
app.get('/prod-zilla-proxy', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const uriParameter = req.query[ANIYAE_HASH];
        ...
        const renderContent = (0, index_1.raidenZillaProxy)(hash);
